...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard', [AdminController::class, 'index'])->name('AdminPanel');
    ...
    Route::post('/user/{userId}/news/{newsId}', [LikeController::class, 'store'])->name('store.like');
    Route::post('/user/{newsId}', [LikeController::class, 'destroy'])->name('store.unlike');
    ...
    Route::get('/profile/update/view', [ProfileController::class, 'passwordView'])->name('profile.update.view');
